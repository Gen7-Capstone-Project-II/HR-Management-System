<template>
      ...
      <div class="popup-content">
        <div class="form-container">
          ...
          <p v-else="!department">no data</p> -->
            ...
            <div class="col-12">
              <button type="button" @click="closePopup2(department)" class="btn btn-danger" style="margin-right: 5px;">Cancel</button>
  ...
  export default {
    methods: {
      closePopup2() {
        this.$emit('closePopup2'); // Emitting an event to notify the parent component to close the popup
      },
    }
  };
  </script>
